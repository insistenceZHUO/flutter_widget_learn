...
class ClipRectBasicPage extends StatefulWidget {
  const ClipRectBasicPage({Key? key}) : super(key: key);

  @override
  _ClipRectBasicPageState createState() => _ClipRectBasicPageState();
}

class _ClipRectBasicPageState extends State<ClipRectBasicPage> {
  @override
